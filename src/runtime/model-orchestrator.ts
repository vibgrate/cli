...
const PACK_CHANNEL = '2026.07.1';

/** Current qualified packs — one primary per mode for v0. */
export const QUALIFIED_PACKS: QualifiedPack[] = [
  {
    ...
    provenance: { notes: 'Spark pack — small coder for constrained machines' },
  },
  {
    ...
    provenance: { notes: 'Flow pack — default daily driver' },
  },
  {
    ...
    provenance: { notes: 'Forge pack — deep work when the machine allows' },
  },
];
