...
export const AGENTS: Readonly<Record<WrapAgent, AgentSpec>> = {
  ...
  copilot: {
    ...
    proxyArgs: (env) => ['--openai-url', copilotApiHost(env)],
  ...
  vibe: {
    ...
    proxyArgs: () => ['--openai-url', 'https://api.mistral.ai'],
    supportsUnwrap: false,
  },
  kimi: {
    id: 'kimi',
    ...
    proxyArgs: () => ['--openai-url', 'https://api.kimi.com/coding'],
    supportsUnwrap: false,
  },
  grok: {
    id: 'grok',
    ...
    proxyArgs: () => ['--openai-url', 'https://api.x.ai'],
    supportsUnwrap: false,
  },
  zcode: {
    id: 'zcode',
  ...
  amp: {
    ...
    method: 'env',
    env: (url) => ({ AMP_URL: url }),
    proxyArgs: () => ['--upstream', 'https://ampcode.com'],
