...
Two-arm benchmark of this release against 2026.708.2, interleaved on one runner against the pinned corpus (157 metrics compared).

| Metric | Previous | This release |
| --- | --- | --- |
| Languages with extraction | 19 count | 19 count |
| Definitions extracted (corpus total) | 18610 count | 18610 count |
| Call edges extracted (corpus total) | 7158 count | 7158 count |
| Locate accuracy (top-1) | 0.97 ratio | 0.97 ratio |
| Dependency detection (authored manifest truth) | 0.96 ratio | 0.96 ratio |
| CLI startup (--version, median) | 607.90 ms | 601.10 ms |
...
Full changelog: https://vibgrate.com/changelog/cli/2026.708.3
