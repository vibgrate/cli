...
Two-arm benchmark of this release against 2026.727.4, interleaved on one runner against the pinned corpus (176 metrics compared).

| Metric | Previous | This release |
| --- | --- | --- |
| Languages with extraction | 19 count | 19 count |
| Definitions extracted (corpus total) | 20986 count | 20986 count |
| Call edges extracted (corpus total) | 9974 count | 9974 count |
| Locate accuracy (top-1) | 0.98 ratio | 0.98 ratio |
| Dependency detection (authored manifest truth) | 0.96 ratio | 0.96 ratio |
| CLI startup (--version, median) | 679 ms | 675.40 ms |
...
Full changelog: https://vibgrate.com/changelog/cli/2026.728.2
